				    ...
				    <div class="panel-body">
						<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/admin/addTeacher" id="editfrom" method="post">
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-10">
								    <input type="date" data-date-format="dd-mm-yyyy"  id="datetimepicker" value="1996-09-02" name="birthyear"/>
							    </div>
							  </div>
							  <div class="form-group">
							...
							<div class="form-group">
							  ...
							  <div class="form-group">
							   ...
							   <div class="form-group">
							    <label for="inputPassword3" class="col-sm-2 control-label">老师简介</label>
							    <div class="col-sm-10">
							      <input type="text" class="form-control" id="inputPassword3" name="intro" placeholder="请输入老师简介">
							    </div>
							  </div>
							  
							   <div class="form-group">
							    <label for="inputPassword3" class="col-sm-2 control-label">老师照片</label>
							    <div class="col-sm-10">
							      <input type="text" class="form-control" id="inputPassword3" name="img" placeholder="请输入老师照片地址">
							    </div>
							  </div>
