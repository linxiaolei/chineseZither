				    ...
				    <div class="panel-body">
						<form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/admin/addStudent" id="editfrom" method="post">
							  <div class="form-group">
							    ...
							    <div class="col-sm-10">
							      <input type="text" class="form-control" id="inputEmail3" name="userid" placeholder="请输入学生手机号"
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-10">
								    <input type="date"  name="grade"/>
							    </div>
							  </div>
							  <div class="form-group">
							    <label for="inputPassword3" class="col-sm-2 control-label" name="collegeid">所属班级</label>
							    <div class="col-sm-10">
