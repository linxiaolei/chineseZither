							...
							<div class="form-group">
							  ...
							  <div class="form-group">
							   ...
							   <div class="form-group">
							    ...
							    <div class="col-sm-10">
							      <input type="text" class="form-control" id="inputPassword3" value="${teacher.intro}" name="intro" placeholder="请输入老师简介">
							    </div>
							  </div>
							   ...
							   <div class="form-group">
							    ...
							    <div class="col-sm-10">
							      <input type="text" class="form-control" id="inputPassword3" name="img" value="${teacher.img}" placeholder="请输入老师照片地址">
							    </div>
							  </div>
